    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex">
                    <select name="id" id="id_barang" class="form-control">
                        <option value="">{{ isset($b_detail) ? $b_detail->nama_barang : '--Pilih Barang--' }}</option>
...
<form action="/transaksi/detail/create" method="POST">
    ...
    <input type="hidden" name="barang_id" value="{{ isset($b_detail) ? $b_detail->id : '' }}">
    <input type="hidden" name="nama_barang" value="{{ isset($b_detail) ? $b_detail->nama_barang : '' }}">
    <input type="hidden" name="subtotal" value="{{ $subtotal }}">

             <div class="mb-3">
                <label for="nama_barang" class="form-label">Nama Barang</label>
                <input type="text" disabled class="form-control" name="nama_barang" value="{{ isset($b_detail) ? $b_detail->nama_barang : '' }}">
            </div>

             <div class="mb-3">
                <label for="harga" class="form-label">Harga Satuan</label>
                <input type="text" disabled class="form-control" name="harga" value="{{ isset($b_detail) ? number_format($b_detail->harga) : ''}}">
            </div>
            ...
            <div class="d-flex">
                <a href="?id={{ request('id') }}&act=min&qty={{ $qty }}" class="btn btn-primary">
                ...
                <input type="number" class="form-control text-center" name="qty" id="qty" value="{{ $qty }}">
                <a href="?id={{ request('id') }}&act=plus&qty={{ $qty }}" class="btn btn-primary">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-2">
                    ...
                    <input type="number" name="kembalian" disabled id="kembalian" class="form-control" value="{{ number_format($kembalian) }}">
                </div>
            </div>
        </div>
    </div>
